...
- `docs/spec.md` - public feature specification and IPC reference.
- `docs/database.md` - public SQLite schema reference.
- `docs/tech-stack.md` - public stack and ADR reference.
...
- Need GitHub-visible or user-facing explanation: read `README.md`, `DEVELOPMENT.md`, `CHANGELOG.md`, or the matching file under `docs/`.
